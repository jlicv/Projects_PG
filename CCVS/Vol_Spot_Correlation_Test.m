...
%Purpose: Check if correlation matrix can perform cholesky
%factorization.Then Compare different models with a set of correlation
%parameters.
...
count_string = sprintf('Successtimes = %d, Failuretimes = %d, Totaltimes = %d.',Successtimes,Failtimes,height(table_rho));
